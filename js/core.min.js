 ...
 */
!function(t){t.fn.cardtable=function(a){var s=t.extend({},{id:"stacktable small-only",hideOriginal:!0,headIndex:0},a);return headIndex=a&&a.headIndex?a.headIndex:0,this.each(function(){if($table=t(this),!$table.hasClass("stacktable")){var a=t(this).prop("class"),d=t("<div></div>");void 0!==s.myClass&&d.addClass(s.myClass);var e="";$table.addClass("stacktable large-only"),$caption=$table.find("caption").clone(),$topRow=$table.find("tr").eq(0),$table.find("tbody tr").each(function(d,l){bodyMarkup=headMarkup="",tr_class=t(this).prop("class"),t(this).find("td,th").each(function(a,s){""!==t(this).html()&&(bodyMarkup+='<tr class="'+tr_class+'">',bodyMarkup=$topRow.find("td,th").eq(a).html()?bodyMarkup+'<td class="st-key">'+$topRow.find("td,th").eq(a).html()+"</td>":bodyMarkup+'<td class="st-key"></td>',bodyMarkup+='<td class="st-val '+t(this).prop("class")+'">'+t(this).html()+"</td>",bodyMarkup+="</tr>")}),e+='<table class=" '+a+" "+s.id+'"><tbody>'+headMarkup+bodyMarkup+"</tbody></table>"}),$table.find("tfoot tr td").each(function(d,l){""!==t.trim(t(l).text())&&(e+='<table class="'+a+" "+s.id+'"><tbody><tr><td>'+t(l).html()+"</td></tr></tbody></table>")}),d.prepend($caption),d.append(t(e)),$table.before(d),s.hideOriginal||$table.show()}})},t.fn.stacktable=function(a){var s=t.extend({},{id:"stacktable small-only",hideOriginal:!0,headIndex:0},a);return headIndex=a&&a.headIndex?a.headIndex:0,this.each(function(){var a=t(this).prop("class");a=t('<table class="'+a+" "+s.id+'"><tbody></tbody></table>');void 0!==s.myClass&&a.addClass(s.myClass);var d="";$table=t(this),$table.addClass("stacktable large-only"),$caption=$table.find("caption").clone(),$topRow=$table.find("tr").eq(0),$table.find("tr").each(function(a,s){bodyMarkup=headMarkup="",tr_class=t(this).prop("class"),0===a?d+='<tr class="st-head-row-wrap '+tr_class+' "><th class="st-head-row st-head-row-main" colspan="2">'+t(this).find("th,td").eq(headIndex).html()+"</th></tr>":(t(this).find("td,th").each(function(a,s){a===headIndex?headMarkup='<tr class="st-head-row-wrap '+tr_class+'"><th class="st-head-row" colspan="2">'+t(this).html()+"</th></tr>":""!==t(this).html()&&(bodyMarkup+='<tr class="'+tr_class+'">',bodyMarkup=$topRow.find("td,th").eq(a).html()?bodyMarkup+'<td class="st-key">'+$topRow.find("td,th").eq(a).html()+"</td>":bodyMarkup+'<td class="st-key"></td>',bodyMarkup+='<td class="st-val '+t(this).prop("class")+'">'+t(this).html()+"</td>",bodyMarkup+="</tr>")}),d+=headMarkup+bodyMarkup)}),a.prepend($caption),a.append(t(d)),$table.before(a),s.hideOriginal||$table.show()})},t.fn.stackcolumns=function(a){var s=t.extend({},{id:"stacktable small-only",hideOriginal:!0},a);return this.each(function(){$table=t(this);var a=$table.find("tr").eq(0).find("td,th").length;if(!(3>a)){var d=t('<table class="'+s.id+'"></table>');void 0!==s.myClass&&d.addClass(s.myClass),$table.addClass("stacktable large-only");for(var e=t("<tbody></tbody>"),l=1;l<a;)$table.find("tr").each(function(a,s){var d=t("<tr></tr>");0===a&&d.addClass("st-head-row st-head-row-main"),first=t(this).find("td,th").eq(0).clone().addClass("st-key");var n=l;if(t(this).find("*[colspan]").length){var r=0;t(this).find("td,th").each(function(a,s){var d=t(this).attr("colspan");if(d?(d=parseInt(d,10),n-=d-1,r+d>l&&(n+=r+d-l-1),r+=d):r++,r>l)return!1})}second=t(this).find("td,th").eq(n).clone().addClass("st-val").removeAttr("colspan"),d.append(first,second),e.append(d)}),++l;d.append(t(e)),$table.before(d),s.hideOriginal||$table.show()}})}}(jQuery);
